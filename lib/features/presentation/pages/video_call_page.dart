...
class _VideoCallPageState extends State<VideoCallPage>
  ...
  void initState() {
    ...
    // Start audio service to keep audio running in background
    AudioServiceManager.startCall(
      callerName: widget.payload.username ?? 'Unknown',
      isVideoCall: true,
    );
    initializeRenderer();
    // Start foreground service for the call
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    // Keep audio active even when app is in background/locked
