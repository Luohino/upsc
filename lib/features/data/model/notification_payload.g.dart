...
Map<String, dynamic> _$NotificationPayloadToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.callerName case final value?) 'callerName': value,
      if (instance.receiverId case final value?) 'receiverId': value,
      if (instance.receiverName case final value?) 'receiverName': value,
      if (instance.receiverProfilePic case final value?)
        'receiverProfilePic': value,
